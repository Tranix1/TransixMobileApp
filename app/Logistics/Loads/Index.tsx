...
// function replaceSpacesWithPercent() {
...
//               </View>}
//         <Text style={{color:'#6a0c0c' , fontSize:15,textAlign :'center' , fontWeight:'600'}}  >{item.companyName} </Text>
...
//       {/* { userId && <View  style={{flexDirection : 'row' , height : 74  ,  paddingLeft : 6 , paddingRight: 15 , paddingTop:10 ,backgroundColor : '#6a0c0c'  , alignItems : 'center'}} >
...
//         {!dspLoadMoreBtn && loadsList.length <= 0 && location&&<Text style={{fontSize:19 ,fontWeight:'bold'}} >Do Not Have Local loads </Text> }
