...
interface ViewContractMoreInfoProps {
    item: Contracts; // Use the Contracts type
}

function ViewContractMoreInfo({  }: ViewContractMoreInfoProps) {
    const { itemG } = useLocalSearchParams();
const item =
  typeof itemG === 'string'
    ? JSON.parse(decodeURIComponent(itemG))
    : null;
