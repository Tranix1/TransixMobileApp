...
interface SlctTruckCapacityProps {
    ...
    setSelectedTruckType: React.Dispatch<React.SetStateAction<string>>;
    selectedCargoArea: { id: number, name: string } | null;
    setSelectedCargoArea   : React.Dispatch<React.SetStateAction<string>>;
    selectedTankerType: { id: number, name: string } | null;
    setSelectedTankerType   : React.Dispatch<React.SetStateAction<string>>;

    selectedTruckCapacity: { id: number, name: string } | null;
    setSelectedTruckCapacity: React.Dispatch<React.SetStateAction<string>>;

    selectedTrailerConfig: { id: number, name: string } | null;
    setSelectedTrailerConfig: React.Dispatch<React.SetStateAction<string>>;

    selectedTruckSuspension: { id: number, name: string } | null;
    setSelectedTruckSuspension: React.Dispatch<React.SetStateAction<string>>;
