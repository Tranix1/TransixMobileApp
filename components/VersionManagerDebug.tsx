...
interface VersionManagerDebugProps {
    visible?: boolean;
}

export default function VersionManagerDebug({ visible = false }: VersionManagerDebugProps) {
    ...
    return (
        <View style={[styles.container, { backgroundColor: background }]}>
            ...
            <View style={styles.buttonContainer}>
                ...
                >
                    <ThemedText style={[styles.buttonText, { color: 'white' }]}>
                        {isLoading ? 'Setting up...' : 'Setup Initial Version'}
                    </ThemedText>
                </TouchableOpacity>
