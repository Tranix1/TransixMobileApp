...
const ProfileItemComponent = ({
    ...
    // Safely get account type styling
    const accTypeStyle =
        profile.type && accTypeColors[profile.type]
            ? accTypeColors[profile.type]
            : {
                  color: textColor,
                  bg: backgroundLight,
              };
        ...
        >
            ...
            <View
                style={[
                    styles.accentBar,
                    {
                        backgroundColor: accTypeStyle.color,
                    },
                ]}
            />
                    ...
                    >
                        <FontAwesome5
                            name={
                                profile.type === 'driver'
                                    ? 'user-alt'
                                    : profile.type === 'brokerage'
                                    ? 'handshake'
                                    : profile.type === 'unverified'
                                    ? 'question-circle'
                                    : 'building'
                            }
                            size={wp(3.2)}
